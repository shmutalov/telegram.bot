...
using Telegram.Bot4.Args;
using Telegram.Bot4.Converters;
using Telegram.Bot4.Exceptions;
using Telegram.Bot4.Types;
using Telegram.Bot4.Types.Enums;
using Telegram.Bot4.Types.InlineQueryResults;
using Telegram.Bot4.Types.Payments;
using Telegram.Bot4.Types.ReplyMarkups;

using File = Telegram.Bot4.Types.File;

namespace Telegram.Bot4
{
    /// <summary>
